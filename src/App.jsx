  ...
  return (
    <div className='px-28'>
      ...
      <div>
        ...
        <input type="text" placeholder='Search contact by name' name='search' id='search' onChange={handleChange} className='block w-full border px-3 py-3 outline-none border-gray-300 shadow-sm sm:text-sm' />
      </div>
